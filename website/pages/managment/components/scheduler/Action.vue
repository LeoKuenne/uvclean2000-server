...
<template>
  <div class="my-1 flex items-center border rounded bg-white"
    ...
    <div class="flex flex-col sm:flex-row flex-grow justify-center items-center space-x-2 p-1"
      :class="[active ? 'border-gray-500' : 'border-gray-300']">
      <select v-model="action.group" :disabled="!active"
        :class="[active ? 'bg-gray-200 p-2 rounded' : '']"
        class="m-1 w-full sm:w-auto">
